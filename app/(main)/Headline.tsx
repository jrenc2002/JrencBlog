...
function Yolo() {
    return (
        <span className="group relative  p-1 pb-2">
                  <svg className="inline-block" height="100%" width="100px" viewBox="0 0 480 360"
            ...
            <g id="main_group">
               ...
               <animate dur="5s" values="0,4000;4000,0" begin="mouseover;0;touchstart" id="animateSig1" fill="freeze" attributeName="stroke-dasharray" attributeType="XML"></animate>
